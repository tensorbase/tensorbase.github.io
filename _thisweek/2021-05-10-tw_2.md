...
In this week, TensorBase team has evaluated the TPC-H Q1 in a full workflow from data ingestion to query! That means TensorBase is becoming into a good sharp for single node.
