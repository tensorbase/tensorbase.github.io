...
In this week, TensorBase continues to improve the static partition pruning. After the week's work, we basically support the human-writing where conditions. This once again shows the thinking of TensorBase to make an industrial-level product. We will soon demonstrate the power of TensorBase's in overall TPC-H benchmarks.
...
🏆🏃🏃‍♂️🏃‍♀️ TB is pretty sure that the beta will come soon. 
